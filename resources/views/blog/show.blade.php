...
<div class="font-article text-article-body-mobile md:text-article-body leading-relaxed text-on-surface dropcap [&_h2]:font-headline-md [&_h2]:text-[32px] [&_h2]:font-semibold [&_h2]:text-primary [&_h2]:mt-12 [&_h2]:mb-4 [&_h2]:font-sans [&_h3]:font-headline-sm [&_h3]:text-[24px] [&_h3]:font-semibold [&_h3]:text-primary [&_h3]:mt-8 [&_h3]:mb-3 [&_h3]:font-sans [&_p]:mb-6 [&_ul]:mb-6 [&_ul]:list-disc [&_ul]:pl-6 [&_ol]:mb-6 [&_ol]:list-decimal [&_ol]:pl-6 [&_blockquote]:border-l-4 [&_blockquote]:border-secondary [&_blockquote]:pl-6 [&_blockquote]:italic [&_blockquote]:text-on-surface-variant [&_blockquote]:my-8 [&_a]:text-secondary [&_a]:underline [&_a]:hover:text-secondary-fixed-dim [&_img]:rounded-xl [&_img]:my-8 [&_img]:w-full [&_pre]:bg-surface-container-high [&_pre]:rounded-xl [&_pre]:p-6 [&_pre]:overflow-x-auto [&_pre]:mb-6 [&_code]:text-sm [&_code]:font-mono">
{!! $post->body !!}
</div>
</article>
