...
<form method="POST" action="{{ route('admin.posts.store') }}" enctype="multipart/form-data" class="grid grid-cols-1 lg:grid-cols-3 gap-8" id="post-form">
    ...
    <div class="lg:col-span-2 space-y-6">
        <div class="bg-white rounded-xl border border-surface-variant shadow-sm p-6">
            <input type="text" name="title" id="title" value="{{ old('title') }}" placeholder="Post title..." class="w-full text-[32px] font-headline-md font-semibold text-primary border-none outline-none focus:outline-none placeholder:text-outline-variant bg-transparent" required/>
