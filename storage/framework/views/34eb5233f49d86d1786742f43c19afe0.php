...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input-label','data' => ['value' => __('Profile Picture')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Profile Picture'))]); ?>
...
<?php endif; ?>
            <div class="mt-2 flex items-center gap-6">
                <div class="shrink-0">
                    <?php if($user->avatar): ?>
                    <img src="<?php echo e($user->avatar_url); ?>" alt="<?php echo e($user->name); ?>" class="w-20 h-20 rounded-full object-cover">
                    <?php else: ?>
                    <div class="w-20 h-20 rounded-full bg-secondary/20 text-secondary flex items-center justify-center text-2xl font-bold">
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <p class="text-xs text-gray-500">JPEG, PNG, GIF, WebP. Max 5MB.</p>
...
<?php /**PATH C:\Users\Onoja\Documents\Elkris\Projects\elkris-blog\resources\views/profile/partials/update-profile-information-form.blade.php ENDPATH**/ ?>