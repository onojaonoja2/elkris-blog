<?php $__env->startSection('title', 'Create Post - Elkris Bio Health'); ?>
<?php $__env->startSection('header', 'Create New Post'); ?>

<?php $__env->startSection('content'); ?>
<form method="POST" action="<?php echo e(route('admin.posts.store')); ?>" enctype="multipart/form-data" class="grid grid-cols-1 lg:grid-cols-3 gap-8" id="post-form">
    <?php echo csrf_field(); ?>

    
    <div class="lg:col-span-2 space-y-6">
        <div class="bg-white rounded-xl border border-surface-variant shadow-sm p-6">
            <input type="text" name="title" id="title" value="<?php echo e(old('title')); ?>" placeholder="Post title..." class="w-full text-[24px] md:text-[32px] font-headline-md font-semibold text-primary border-none outline-none focus:outline-none placeholder:text-outline-variant bg-transparent" required/>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="bg-white rounded-xl border border-surface-variant shadow-sm">
            ...
            <div class="p-6">
                ...
                <input type="hidden" name="body" id="body-content" value="<?php echo e(old('body')); ?>">
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="bg-white rounded-xl border border-surface-variant shadow-sm p-6">
            ...
            <textarea name="excerpt" rows="3" class="w-full border border-outline-variant rounded-lg px-4 py-3 text-ui-label text-on-surface focus:outline-none focus:ring-2 focus:ring-secondary/20 focus:border-secondary bg-surface-container-lowest" placeholder="Brief summary for cards and SEO..."><?php echo e(old('excerpt')); ?></textarea>
        ...
        <div class="bg-white rounded-xl border border-surface-variant shadow-sm p-6 space-y-4 sticky top-24">
            ...
            <div>
                ...
                <div class="flex flex-wrap gap-2">
                    ...
                    <label class="inline-flex items-center gap-2 px-3 py-2 rounded-lg border border-outline-variant cursor-pointer hover:bg-surface-container-high transition-colors has-checked:bg-secondary-container has-checked:border-secondary has-checked:text-on-secondary-container">
                        <input type="checkbox" name="tags[]" value="<?php echo e($tag->id); ?>" class="hidden" <?php if(in_array($tag->id, old('tags', []))): echo 'checked'; endif; ?>>
            ...
            <div>
                ...
                <div class="border-2 border-dashed border-outline-variant rounded-xl p-6 text-center cursor-pointer hover:border-secondary transition-colors" id="upload-featured-image">
                    ...
                    <p class="text-caption text-outline">Click to upload image</p>
...
unset($__errorArgs, $__bag); ?>
                ...
                <select name="image_position" class="w-full border border-outline-variant rounded-lg px-4 py-3 text-ui-label text-on-surface focus:outline-none focus:ring-2 focus:ring-secondary/20 focus:border-secondary bg-surface-container-lowest mt-3">
                    <option value="top" <?php if(old('image_position') == 'top'): echo 'selected'; endif; ?>>Display at top</option>
                    <option value="middle" <?php if(old('image_position') == 'middle'): echo 'selected'; endif; ?>>Display in middle</option>
                    <option value="end" <?php if(old('image_position') == 'end'): echo 'selected'; endif; ?>>Display at end</option>
                </select>
            </div>
...
unset($__errorArgs, $__bag); ?>
                ...
                <select name="video_position" class="w-full border border-outline-variant rounded-lg px-4 py-3 text-ui-label text-on-surface focus:outline-none focus:ring-2 focus:ring-secondary/20 focus:border-secondary bg-surface-container-lowest mt-3">
                    <option value="end" <?php if(old('video_position') == 'end'): echo 'selected'; endif; ?>>Display at end</option>
                    <option value="top" <?php if(old('video_position') == 'top'): echo 'selected'; endif; ?>>Display at top</option>
                    <option value="middle" <?php if(old('video_position') == 'middle'): echo 'selected'; endif; ?>>Display in middle</option>
                </select>
            </div>

            <div>
                <label class="font-ui-label font-bold text-primary mb-2 block">Image Caption</label>
                <input type="text" name="featured_image_caption" value="<?php echo e(old('featured_image_caption')); ?>" class="w-full border border-outline-variant rounded-lg px-4 py-3 text-ui-label text-on-surface focus:outline-none focus:ring-2 focus:ring-secondary/20 focus:border-secondary bg-surface-container-lowest" placeholder="Optional caption...">
            </div>

            <div class="border-t border-outline-variant pt-4">
                <label class="font-ui-label font-bold text-primary mb-2 block">SEO Settings</label>
                <div class="space-y-3">
                    <input type="text" name="seo_title" value="<?php echo e(old('seo_title')); ?>" class="w-full border border-outline-variant rounded-lg px-4 py-3 text-ui-label text-on-surface focus:outline-none focus:ring-2 focus:ring-secondary/20 focus:border-secondary bg-surface-container-lowest" placeholder="SEO Title (leave blank to use post title)">
...
<?php echo $__env->make('admin.layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Onoja\Documents\Elkris\Projects\elkris-blog\resources\views/admin/posts/create.blade.php ENDPATH**/ ?>